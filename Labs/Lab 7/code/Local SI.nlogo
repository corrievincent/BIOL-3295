...
to calc-rates
  ...
  ask susceptibles [
    ...
    set cum-globinfect cum-locinfect +  P * xI
...
to select-event
  ...
  ifelse item 0 [breed] of turtle-select  = susceptibles [
    ...
    if blr3 < item 0 [cum-locinfect] of turtle-select and j < 1
...
"" ""
PENS
"pII" 1.0 0 -2674135 true "" "plot pII"
"pSS" 1.0 0 -16449023 true "" "plot pSS"
"pS0" 1.0 0 -7500403 true "" "plot pS0"
"pSI" 1.0 0 -10873583 true "" "plot pSI"
"p00" 1.0 0 -3026479 true "" "plot p00"
"pI0" 1.0 0 -1069655 true "" "plot pI0"
...
This model is a spatially explicit ABM describing infection dynamics to be compared with pair approximation equations. The model assumes: 1) that infection can only be spread to a susceptible neighbour, and 2) that only susceptibles can reproduce and reproduction can only occur into a neighbouring site that is unoccuppied.
